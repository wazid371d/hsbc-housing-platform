...
`render.yaml` defines all four services — three private backends and one public web app.
Connect the repo as a Render Blueprint. Update the `*_CORS_*` origins and the public web
service name to match your Render URL.
